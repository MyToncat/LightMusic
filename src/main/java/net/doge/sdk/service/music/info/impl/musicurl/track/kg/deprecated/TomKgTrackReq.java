...
//
//public class TomKgTrackReq {
//    private static TomKgTrackReq instance;
//
//    private TomKgTrackReq() {
//        initMap();
//    }
//
//    public static TomKgTrackReq getInstance() {
//        if (instance == null) instance = new TomKgTrackReq();
//        return instance;
//    }
//
//    // 歌曲 URL 获取 API (酷狗)
//    // https://github.com/CharlesPikachu/musicdl/blob/master/musicdl/modules/sources/kugou.py
//    private final String SONG_URL_KG_API = "https://music.tom.moe/";
//
...
//                    .header(Header.REFERER, "https://music.tom.moe/")
...
//        TomKgTrackReq trackReq = getInstance();
