...
//
//public class LzmhhhNcTrackReq {
//    private static LzmhhhNcTrackReq instance;
//
//    private LzmhhhNcTrackReq() {
//        initMap();
//    }
//
//    public static LzmhhhNcTrackReq getInstance() {
//        if (instance == null) instance = new LzmhhhNcTrackReq();
//        return instance;
//    }
//
//    // 歌曲 URL 获取 API (网易云)
//    // https://github.com/CharlesPikachu/musicdl/blob/master/musicdl/modules/sources/netease.py
//    private final String SONG_URL_NC_API = "https://music.lzmhhh.com/api/music/url";
//
...
//                    .header(Header.REFERER, "https://music.lzmhhh.com/")
//                    .header(Header.ORIGIN, "https://music.lzmhhh.com")
//                    .jsonBody(String.format("{\"id\":\"%s\",\"type\":\"wy\"}", id))
//                    .executeAsStr();
...
//        LzmhhhNcTrackReq trackReq = getInstance();
