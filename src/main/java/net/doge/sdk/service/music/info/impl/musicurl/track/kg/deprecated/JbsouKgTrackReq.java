//package net.doge.sdk.service.music.info.impl.musicurl.track.kg.deprecated;
//
...
//
//public class JbsouKgTrackReq {
//    private static JbsouKgTrackReq instance;
//
//    private JbsouKgTrackReq() {
//        initMap();
//    }
//
//    public static JbsouKgTrackReq getInstance() {
//        if (instance == null) instance = new JbsouKgTrackReq();
//        return instance;
//    }
//
//    // 歌曲 URL 获取 API (酷狗)
//    // https://github.com/CharlesPikachu/musicdl/blob/master/musicdl/modules/sources/kugou.py
//    private final String SONG_URL_KG_API = "https://www.jbsou.cn/";
//
...
//        try {
//            String songBody = HttpRequest.post(SONG_URL_KG_API)
//                    .header(Header.REFERER, "https://www.jbsou.cn/")
//                    .header("X-Requested-With", "XMLHttpRequest")
//                    .jsonBody(String.format("{\"input\":\"%s\",\"filter\":\"id\",\"type\":\"kugou\",\"page\":\"1\"}", hash))
//                    .executeAsStr();
...
//        JbsouKgTrackReq trackReq = getInstance();
