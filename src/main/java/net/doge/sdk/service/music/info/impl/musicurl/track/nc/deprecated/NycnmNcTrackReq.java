...
//
//public class NycnmNcTrackReq {
//    private static NycnmNcTrackReq instance;
//
//    private NycnmNcTrackReq() {
//        initMap();
//    }
//
//    public static NycnmNcTrackReq getInstance() {
//        if (instance == null) instance = new NycnmNcTrackReq();
//        return instance;
//    }
//
//    // 歌曲 URL 获取 API (网易云)
//    private final String SONG_URL_NC_API = "https://api.nycnm.cn/API/163music.php?ids=%s&level=%s&type=json&apikey=%s";
//
//    private final String[] REQUEST_KEYS = {
//            "ZTYxMDlhMDJiYmYwMjg1MmJhZmIwMGE5ZjIzNWZlYWVjZDk4NTBhNjBlNWYyYmQ0YzQxYWNjYTczNjQwNGIwZA==",
//            "OWMxOGVmMTVhYjM2ODRjMGE4NTQ0ODZlYTg4MzcxZTQ1MDNjM2JjMWZjODYzODI1OTgzNzQwZGU5NTU3NTljYg=="
//    };
//
...
//        NycnmNcTrackReq trackReq = getInstance();
