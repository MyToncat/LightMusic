...
//
//public class HaitangwNcTrackReq {
//    private static HaitangwNcTrackReq instance;
//
//    private HaitangwNcTrackReq() {
//        initMap();
//    }
//
//    public static HaitangwNcTrackReq getInstance() {
//        if (instance == null) instance = new HaitangwNcTrackReq();
//        return instance;
//    }
//
//    // 歌曲 URL 获取 API (网易云)
//    private final String SONG_URL_NC_API = "https://musicapi.haitangw.net/music/wy.php?id=%s&level=%s&type=json";
//
...
//        HaitangwNcTrackReq trackReq = getInstance();
